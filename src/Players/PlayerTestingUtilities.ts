import { map, over, size, first, curry } from "lodash/fp";
...
import { convertToSet, splitOnUnderscores } from "../Common/Transformers";

export const getActualPositionGroupSet = flowAsync(
...
export const getActualPositionCountStartingIndexTuplesSet = flowAsync(
  over([
    filterGoalkeepersByID,
    filterMidfieldersByID,
    filterAttackersByID,
